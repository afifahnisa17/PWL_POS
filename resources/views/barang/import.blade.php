        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="template_barang">Download Template</label>
                ...
                <div class="form-group">
                    <label for="file_barang">Pilih File</label> <!-- Update di sini -->
    ...
    $(document).ready(function() {
        ...
        $("#form-import").validate({
            ...
            submitHandler: function(form) {
                var formData = new FormData(form); // Membuat FormData untuk menghandle file

                // Ajax untuk mengirim data form
                $.ajax({
                    url: form.action,
                    type: form.method,
                    data: formData,  // Mengirim data berupa FormData
