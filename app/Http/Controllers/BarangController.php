...
class BarangController extends Controller
{
    ...
    {
        $barang = BarangModel::select('barang_id', 'kategori_id', 'barang_kode', 'barang_nama', 'harga_jual', 'harga_beli')
            ->with('kategori');
        ...
        if ($request->ajax() || $request->wantsJson()) {
            ...
            if ($validator->fails()) {
                return response()->json([
                    ...
                    'msgField' => $validator->errors()->all(), // Tampilkan semua pesan error
                ]);
            }
        ...
        if ($request->ajax() || $request->wantsJson()) {
            ...
            if ($check) {
                if (!$request->filled('harga_beli')) {
                    // jika harga_beli tidak diisi, maka hapus dari request
                    $request->request->remove('harga_beli');
                }
